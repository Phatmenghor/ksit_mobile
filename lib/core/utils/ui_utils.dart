...
class UIUtils {
  ...
  static Widget buildStatusBadge({
    ...
    Color bgColor = backgroundColor ?? AppColors.primary.withOpacity(0.1);
    Color txtColor = textColor ?? AppColors.primary;

    // Set colors based on status
    try {
      final statusEnum = RequestStatusExtension.fromString(status);
      switch (statusEnum) {
      ...
      // Use default colors if status is not recognized
    }
  ...
  static Widget buildPriorityBadge({
